        ...
        <div class=" main-content-area">
                            ...
                            <li class="pr-cart-item">
                                ...
                                <div class="quantity">
                                    <div class="quantity-input">
                                        ...
                                        <a class="btn btn-increase" href="/cart" wire:click="increaseQuantity('{{$item->rowId}}')"></a>
                                        <a class="btn btn-reduce" href="/cart" wire:click="decreaseQuantity('{{$item->rowId}}')"></a>
                                    </div>
                                </div>
                                ...
                                <div class="delete">
                                    <a href="/cart" wire:click="destroy('{{$item->rowId}}')" class="btn btn-delete" title="">
            ...
            <div class="summary">
                ...
                <div class="update-clear">
                    <a class="btn btn-clear" href="/cart" wire:click="destroyAll()">Clear Shopping Cart</a>
