        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title" style=" text-transform: uppercase;">Digital & Electronics</h1>
                        ...
                        <ul class="list-category">
                            @foreach ($categories as $category)
                                <li class="category-item">
                                    <a href="{{route('product.category',['category_slug'=>$category->slug])}}" class="cate-link" style=" text-transform: uppercase;">{{$category->name}}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
