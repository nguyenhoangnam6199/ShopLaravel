        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <div class="widget mercado-widget widget-product">
                    ...
                    <div class="widget-content slides">
                        <ul class="products">
                                    ...
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span
                                                    class="product-price">${{ $p->regular_price }}</span></div>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                            ...
                            @foreach ($related as $r)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.details', ['slug' => $r->slug]) }}" title="{{ $r->name }}">
                                            <figure>
                                                <img src="{{ asset('assets/images/products') }}/{{$r->image}}"
                                        ...
                                        <div class="wrap-btn">
                                            <a href="{{ route('product.details', ['slug' => $r->slug]) }}" class="function-link">quick view</a>
                                        </div>
                                    </div>
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span
                                                class="product-price">${{ $r->regular_price }}</span></div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
